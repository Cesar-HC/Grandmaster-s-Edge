    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/jugador/correo/**").permitAll()
                        .requestMatchers("/api/jugador/id/**").permitAll()
                        .requestMatchers("/api/jugadores").permitAll()
                        .requestMatchers("/api/partida").permitAll()
                        .requestMatchers("/api/partida/id/**").permitAll()
                        .requestMatchers("/api/partidas").permitAll()
                        .requestMatchers("/api/ficha").permitAll()
                        .requestMatchers("/api/fichas").permitAll()
                        .requestMatchers("/api/ficha/id/**").permitAll()
